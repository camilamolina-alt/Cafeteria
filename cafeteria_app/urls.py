...
urlpatterns = [
    ...
    path('cart/remove/base/<product_id>/', views.remove_from_cart_base, name='remove_from_cart_base'),
    path('checkout/', views.checkout, name='checkout'),
    path('product/<id>/', views.product_detail, name='products_detail'),
    path('events/<id>/send/', views.Send.as_view(), name='send'),
]